    ...
    function search_code_voucher() {
        ...
        if (empty($data)) {
            ...
            $result = '<div class="bo21 p-l-10 p-t-10 p-r-10 p-b-10 fs-13">'
                    ...
                    . '</div>'
                    . '<button class="btn-sm btn-block bg-hover-brown fs-13" onclick="useVoucher(' . $str . '' . $data->voucherPrice . '' . $str . ',' . $str . '' . $data->idvoucher . '' . $str . ',' . $str . '' . $data->voucherName . '' . $str . ',' . $str . '' . $data->voucherCode . '' . $str . ',' . $str . '' . $data->voucherDescription . '' . $str . ');">Gunakan Voucher ini</button>';
        }
        echo $result;
    }
