...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo base_url('asset/') ?>vendors/datatables/css/dataTables.bootstrap4.min.css">
        ...
        <div class="wrap_menu">
            <nav class="menu">
                <ul class="main_menu">
                    ...
                    <li>
                        <a href="javascript:void(0);" class="openBtn" onclick="openSearch()"><i class="fa xfa-search"></i> Cari Produk</a>
                    </li>
                </ul>
            </nav>
        </div>
                ...
                <div class="header-cart header-dropdown">
                    ...
                    <div class="header-cart-buttons">
                        <div class="header-cart-wrapbtn">
                            <a href="<?php echo base_url('pages/cart?idorder='); ?>
                            <?php
